...
# Este script era originalmente um notebook do Google Colab
# Robson Ricardo, Guilherme Duarte e Felipe Toledo
...
# Passo 1: descompactar o arquivo .zip contendo o dataset de treinamento
caminho_zip = '/content/drive/MyDrive/Garbage.zip'

# Pasta de destino para os arquivos descompactados no ambiente do Colab
pasta_descompactada = '/content/Garbage'
print(f"Descompactando '{caminho_zip}' para '{pasta_descompactada}'...")
...
try:
    ...
    print(f"❌ ERRO: Ocorreu um problema ao descompactar o arquivo: {e}")


# Passo 2: Treinar o modelo com o dataset descompactado
...
pasta_raiz_origem = '/content/Garbage'
caminho_modelo_salvo = '/content/drive/MyDrive/modelo_garbage_inception_v1.keras'

# 2. Data Augmentation com o PRÉ-PROCESSAMENTO ---
...
# Lógica para lidar com pastas aninhadas
...
# Verifica o número de classes e imagens
